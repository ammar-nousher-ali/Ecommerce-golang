...
import (
	...
	generate "github.com/ammar-nousher-ali/go-ecommerce/tokens"
...
func Signup() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.JSON(http.StatusCreated, "Sucessfully Signed Up!!")
...
func SearchProduct() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if err != nil {
			...
			c.IndentedJSON(http.StatusInternalServerError, "something went wrong pleae try after sometime")
			return
...
func SearchProductByQuery() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		//you want to check if query is empty
		if queryParam == "" {
